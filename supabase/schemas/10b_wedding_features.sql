...
-- NOTE: Must load before 11_subscription_orders.sql (which references wedding_subscriptions)
...
CREATE TABLE IF NOT EXISTS public.wedding_settings (
  ...
  -- Default view for guests/invitations page
  default_guest_view TEXT DEFAULT 'groups' CHECK (default_guest_view IN ('flat', 'groups')),
