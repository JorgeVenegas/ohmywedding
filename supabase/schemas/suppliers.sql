-- Suppliers management: track wedding vendors (DJ, catering, photography, etc.)
...
create index "idx_suppliers_wedding" on suppliers (wedding_id);
...
create index "idx_supplier_payments_wedding" on supplier_payments (wedding_id);
