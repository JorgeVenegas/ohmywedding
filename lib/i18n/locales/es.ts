...
export const es: Translations = {
  ...
  rsvp: {
    ...
    selectMealPreference: 'Selecciona una preferencia',
    ...
    submitting: 'Enviando...',
    thankYou: '¡Gracias!',
    confirmationMessage: '¡Hemos recibido tu confirmación y no podemos esperar para celebrar contigo!',
    ...
    pleaseRespondForEveryone: 'Por favor responde por todos en tu grupo',
    ...
    individualInvitationsMessage: 'Las invitaciones individuales se enviarán a cada invitado de forma privada'
  },
