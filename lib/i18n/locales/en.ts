...
export const en: Translations = {
  ...
  rsvp: {
    ...
    cannotAttend: "Can't make it",
    yes: 'Yes',
    no: 'No',
    numberOfGuests: 'Number of Guests',
    guestNames: 'Guest Names',
    mealPreference: 'Meal Preference',
    selectMealPreference: 'Select a meal preference',
    ...
    submitting: 'Sending...',
    thankYou: 'Thank You!',
    confirmationMessage: "We've received your RSVP and can't wait to celebrate with you!",
    ...
    pleaseRespondForEveryone: 'Please respond for everyone in your group',
    ...
    tryAgain: 'Try Again',
    individualInvitationsMessage: 'Individual invitations will be sent to each guest privately'
  },
