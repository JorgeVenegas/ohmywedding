          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b-2 border-[#420c14]/10">
                ...
                <th className="text-center py-4 px-4 font-medium text-[#420c14]/40 text-xs uppercase tracking-wider w-28">Basic</th>
                <th className="text-center py-4 px-4 font-medium text-[#DDA46F] text-xs uppercase tracking-wider w-28 bg-[#DDA46F]/5 rounded-t-xl">Personalized</th>
              </tr>
            </thead>
            <tbody>
