  ...
  return (
    <main className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-1 relative overflow-hidden min-w-0">
        ...
        {/* Floating Toolbar — now at bottom, centered */}
        ...
        <AnimatePresence>
          {selectedElement && (
            <motion.div
              ...
              className="absolute top-20 left-1/2 -translate-x-1/2 z-20 bg-white rounded-xl shadow-lg border border-gray-200/60 px-3 py-2.5 flex items-center gap-2"
            >
              <span className="text-[11px] font-medium text-gray-500 mr-0.5">Color</span>
