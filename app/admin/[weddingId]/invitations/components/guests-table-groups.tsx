            ...
            <thead className="bg-muted/20 border-b border-border">
              <tr>
                ...
                <th className="px-3 py-2 text-left">
                  ...
                  >
                    {t('admin.invitations.table.groupName')}
                    {sortColumn === 'name' ? (
                ...
                <th className="px-3 py-2 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                  {t('admin.invitations.table.guestsCount')}
                </th>
                <th className="px-3 py-2 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                ...
                {visibleColumns.tags && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.tags')}
                  </th>
                )}
                {visibleColumns.invitedBy && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.invitedBy')}
                  </th>
                )}
                {visibleColumns.inviteSent && (
                  <th className="px-3 py-2 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.invite')}
                  </th>
                )}
                {visibleColumns.travelInfo && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.travelInfo')}
                  </th>
                )}
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className={`font-medium ${!group.name ? 'italic text-muted-foreground' : 'text-foreground'}`}>
                              {group.name || t('admin.invitations.table.unnamedGroup')}
                            </span>
                            ...
                            {!group.name && (
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-xs">{t('admin.invitations.table.needsNameClick')}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            )}
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  {group.open_count > 0 ? (
                                    <>
                                      <p>{t('admin.invitations.opens.openedTimes', { count: group.open_count })}</p>
                                      {group.first_opened_at && (
                                        <p className="text-xs opacity-80">
                                          {t('admin.invitations.opens.firstOpened', { date: new Date(group.first_opened_at).toLocaleDateString() })}
                                        </p>
                                      )}
                                    </>
                                  ) : (
                                    <p>{t('admin.invitations.opens.notOpened')}</p>
                                  )}
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          ...
                          <div className="flex items-center justify-center gap-2">
                            ...
                            {allGuestsInvited ? (
                              <button
                                ...
                                title={t('admin.invitations.table.clickMarkNotSent')}
                              >
                              ...
                              <button
                                ...
                                className="hover:opacity-70 transition-opacity"
                                title={t('admin.invitations.table.clickMarkSent')}
                              >
                                <Mail className="w-3.5 h-3.5 text-amber-600" />
                              </button>
                            ) : (
                              <span title={t('admin.invitations.table.noInvitesSent')}>
                            ...
                            <Button
                              ...
                              title={t('admin.invitations.table.openRsvpPage')}
                            >
                            ...
                            <Button
                              ...
                              title={t('admin.invitations.table.copyRsvpLink')}
                            >
                            ...
                            {!allGuestsInvited && (
                              <Button
                                ...
                                title={t('admin.invitations.table.sendInvite')}
                              >
                              ...
                              <TooltipProvider>
                                <div className="flex items-center gap-1">
                                  <Tooltip>
                                    ...
                                    <TooltipContent>
                                      <p>{t('admin.invitations.travel.isTraveling')}</p>
                                    </TooltipContent>
                                  </Tooltip>
                                  {willBuyTicket && (
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p>{t('admin.invitations.travel.willPurchaseTicket')}</p>
                                      </TooltipContent>
                                    </Tooltip>
                                  )}
                                  {noTicketNeeded && (
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p>{t('admin.invitations.travel.noTicketNeeded')}</p>
                                      </TooltipContent>
                                    </Tooltip>
                                  )}
                                  {hasTicketUploaded && (
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p>{t('admin.invitations.travel.ticketVerified')}</p>
                                      </TooltipContent>
                                    </Tooltip>
                                  )}
                                </div>
                        ...
                        {group.guests.length === 0 ? (
                          <tr className="bg-muted/20">
                            <td colSpan={11} className="px-8 py-4 text-center text-muted-foreground">
                              <p className="mb-2">{t('admin.invitations.table.noGuestsInGroup')}</p>
                              <Button
                                variant="outline"
                                size="sm"
                                onClick={(e) => {
                                    ...
                                    <TooltipProvider>
                                      <div className="flex items-center gap-1">
                                        <Tooltip>
                                          ...
                                          <TooltipContent>
                                            <p>{t('admin.invitations.travel.isTraveling')}{guest.traveling_from ? ` from ${guest.traveling_from}` : ''}</p>
                                          </TooltipContent>
                                        </Tooltip>
                                        {guest.travel_arrangement === 'will_buy_ticket' && (
                                          <Tooltip>
                                            ...
                                            <TooltipContent>
                                              <p>{t('admin.invitations.travel.willPurchaseTicket')}</p>
                                              <p className="text-xs opacity-80">{t('admin.invitations.travel.verificationRequired')}</p>
                                            </TooltipContent>
                                          </Tooltip>
                                        )}
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="font-medium text-amber-800">{t('admin.invitations.table.ungroupedGuests')}</div>
                          <div className="text-xs text-amber-600">{t('admin.invitations.table.legacyNeedsGroup')}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-3 py-2 text-center">
