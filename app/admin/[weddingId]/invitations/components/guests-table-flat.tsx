            ...
            <thead className="bg-muted/20 border-b border-border">
              <tr>
                ...
                <th className="px-3 py-2 text-left">
                  ...
                  >
                    {t('admin.invitations.table.name')}
                    {sortColumn === 'name' ? (
                ...
                {visibleColumns.phone && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.phone')}
                  </th>
                )}
                {visibleColumns.group && (
                  <th className="px-3 py-2 text-left">
                    <button
                      ...
                      className="flex items-center gap-1 text-xs font-semibold text-muted-foreground uppercase tracking-wide hover:text-foreground transition-colors"
                    >
                      {t('admin.invitations.table.group')}
                      {sortColumn === 'group' ? (
                        sortDirection === 'asc' ? <ArrowUp className="w-3 h-3" /> : <ArrowDown className="w-3 h-3" />
                      ) : (
                        <ArrowUpDown className="w-3 h-3 opacity-30" />
                ...
                {visibleColumns.dietary && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.dietary')}
                  </th>
                )}
                ...
                {visibleColumns.seating && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.tableName')}
                  </th>
                )}
                {visibleColumns.dish && (
                  <th className="px-3 py-2 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">
                    {t('admin.invitations.table.dish')}
                  </th>
                )}
                    ...
                    <td className="px-3 py-2">
                      <div className="flex items-center gap-1">
                        {guest.groupName !== undefined && guest.groupName !== null ? (
                          ...
                          <>
                            <span className="italic text-muted-foreground">{t('admin.invitations.table.unnamedGroup')}</span>
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-xs">{t('admin.invitations.table.needsName')}</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          </>
                        ) : (
                          <span className="italic text-muted-foreground/50">{t('admin.invitations.toolbar.ungrouped')}</span>
                        )}
                      </div>
                    </td>
                  )}
                    ...
                    <td className="px-3 py-2 text-center">
                      {guest.invitation_sent ? (
                        ...
                        >
                          ...
                          {t('admin.invitations.table.sent')}
                        </button>
                      ) : guest.phone_number ? (
                        <Button
                          variant="ghost"
                        ...
                        >
                          ...
                          {t('admin.invitations.table.send')}
                        </Button>
                      ) : null}
                    </td>
                  )}
