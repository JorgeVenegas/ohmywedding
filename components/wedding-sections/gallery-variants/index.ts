...
export { GalleryCollageVariant } from './gallery-collage-variant'
export { GalleryHaciendaVariant } from './gallery-hacienda-variant'
export { GalleryOldMoneyVariant } from './gallery-old-money-variant'
