            ...
            <form onSubmit={handleSubmitClick} className="space-y-8">
              ...
              {(groupData?.extra_passes || 0) > 0 && (
                <div className="space-y-3 pt-2">
                  ...
                  >
                    <label className="block text-sm font-serif font-light tracking-wide mb-3 text-center" style={{ color: titleColor }}>
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <button
                        ...
                        className="w-10 h-10 rounded-full border-2 flex items-center justify-center text-lg font-light transition-all hover:scale-105 disabled:opacity-40"
