...
import { X, Crown, Heart, Clock, MapPin, Image, Mail, HelpCircle, Gift, Shirt, Hotel } from 'lucide-react'
...
const AVAILABLE_SECTIONS: SectionType[] = [
  ...
  },
  {
    ...
    description: 'Recommend nearby hotels for out-of-town guests',
    icon: <Hotel className="w-5 h-5" style={{ color: GOLD_COLOR }} strokeWidth={1.5} />
  }
]
